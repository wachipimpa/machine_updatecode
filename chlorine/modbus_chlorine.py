...
path_url = Path_url()
class Modbus_chlorine:
        
    def read_chlorine_counter(self):
        read_ph = open('/home/pi/txt_file/counter_chlorine.txt','r')
        return int(read_ph.read())
    
    def write_chlorine_counter(self):
        counter_ph = self.read_chlorine_counter()
        counter_ph += 1
        write_ph = open('/home/pi/txt_file/counter_chlorine.txt','w')
        write_ph.write(str(counter_ph))

    def set_chlorine_counter_zero(self):
        write_ph = open('/home/pi/txt_file/counter_chlorine.txt','w')
        write_ph.write("0")
